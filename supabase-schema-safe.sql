-- Safe schema setup for shared Supabase projects
-- This version handles existing triggers and functions gracefully
...
-- Note: This reuses the existing on_auth_user_created trigger
-- Only run this if you DON'T have this trigger from another project
-- If the trigger already exists and works for your other projects, SKIP THIS SECTION

-- Uncomment below ONLY if you need to recreate the trigger:
/*
